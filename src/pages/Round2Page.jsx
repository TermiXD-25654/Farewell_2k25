  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-900 via-indigo-900 to-blue-800 flex flex-col items-center justify-center text-white p-4 relative overflow-hidden">
      ...
      <div className="absolute inset-0 overflow-hidden z-0">
        ...
        <div className="absolute bottom-1/3 left-1/4 w-72 h-72 bg-indigo-500 opacity-10 rounded-full blur-3xl animate-pulse" style={{animationDelay: '1.5s'}}></div>
      </div>
              ...
              {!completed ? (
                <>
                  <p className="mb-8 text-center text-lg text-blue-300">
                    Rearrange the tiles to complete the image. Click on a tile to move it.
                  </p>
                        ...
                        return (
                          <div
                            ...
                            className={`relative cursor-pointer transition-all duration-200 rounded-md transform hover:scale-105 ${
                              isEmptyTile ? 'bg-transparent' : 'bg-gray-800/70 shadow-md'
                            }`}
                            style={{
                              backgroundImage: isEmptyTile ? 'none' : `url(${ROUND_2_CONFIG.imagePath})`,
